...
if ~isempty(settings.obs.data.prec)
    P = EnKF_Prepare_Data(settings.obs.data, ...
             'prec', ...
             'prec', ...
             settings.id_var, ...
             settings.region_ids, ...
...
if ~isempty(settings.obs.data.evap)             
    E = EnKF_Prepare_Data(settings.obs.data, ...
             'evap', ...
             'evap', ...
             settings.id_var, ...
             settings.region_ids, ...
...
if ~isempty(settings.obs.data.runoff)
    R = EnKF_Prepare_Data(settings.obs.data, ...
             'runoff', ...
             'runoff', ...
             settings.id_var, ...
             settings.region_ids, ...
...
if ~isempty(settings.obs.data.twsc)
    DM = EnKF_Prepare_Data(settings.obs.data, ...
             'twsc', ...
             'twsc', ...
             settings.id_var, ...
             settings.region_ids, ...
...
if ~isempty(settings.obs.p_alt)
    P_alt = EnKF_Prepare_Data(settings.obs.e_alt, ...
                 'prec', ...
                 'prec', ...
                 settings.id_var, ...
                 settings.region_ids, ...
...
if ~isempty(settings.obs.e_alt)
    E_alt = EnKF_Prepare_Data(settings.obs.e_alt, ...
                 'evap', ...
                 'evap', ...
                 settings.id_var, ...
                 settings.region_ids, ...
...
if ~isempty(settings.obs.r_alt)
    R_alt = EnKF_Prepare_Data(settings.obs.r_alt, ...
                 'runoff', ...
                 'runoff', ...
                 settings.id_var, ...
                 settings.region_ids, ...
...
if ~isempty(settings.obs.dm_alt)
    DM_alt = EnKF_Prepare_Data(settings.obs.dm_alt, ...
                 'twsc', ...
                 'twsc', ...
                 settings.id_var, ...
                 settings.region_ids, ...
