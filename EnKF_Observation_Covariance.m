...
if strcmp(settings.obscov.errs_P.method, 'ensemble') 
    ...
    P_back = prep_dta(settings.obscov.data_back, ...
                       'prec', ...
                       'prec', ...
                       settings.id_var, ...
                       settings.region_ids, ...
    ...
    P_scle = prep_dta(settings.obscov.data_scle, ...
                       'prec', ...
                       'prec', ...
                       settings.id_var, ...
                       settings.region_ids, ...
...
elseif strcmp(settings.obscov.errs_P.method, 'data')
    ...
    P_in = prep_dta(settings.obscov.errs_P.data, ...
                    [], ...
...
if strcmp(settings.obscov.errs_E.method, 'ensemble')               
    ...
    E_back = prep_dta(settings.obscov.data_back, ...
                      'evap', ...
                      'evap', ...
                      settings.id_var, ...
                      settings.region_ids, ...
    ...
    E_scle = prep_dta(settings.obscov.data_scle, ...
                      'evap', ...
                      'evap', ...
                      settings.id_var, ...
                      settings.region_ids, ...
...
elseif strcmp(settings.obscov.errs_E.method, 'data')
    % Load an ancillary time-series for deriving the percentage errors
    E_in = prep_dta(settings.obscov.errs_E.data, ...
                    [], ...
...
if strcmp(settings.obscov.errs_R.method, 'ensemble')       
    ...
    R_back = prep_dta(settings.obscov.data_back, ...
                      'runoff', ...
                      'runoff', ...
                      settings.id_var, ...
                      settings.region_ids, ...
    ...
    R_scle = prep_dta(settings.obscov.data_scle, ...
                      'runoff', ...
                      'runoff', ...
                      settings.id_var, ...
                      settings.region_ids, ...
...
elseif strcmp(settings.obscov.errs_R.method, 'data')
    % Load an ancillary time-series for deriving the percentage errors
    R_in = prep_dta(settings.obscov.errs_R.data, ...
                    [], ...
...
if strcmp(settings.obscov.errs_DM.method, 'ensemble')  
    ...
    DM_back = prep_dta(settings.obscov.data_back, ...
                      'twsc', ...
                      'twsc', ...
                      settings.id_var, ...
                      settings.region_ids, ...
    ...
    DM_scle = prep_dta(settings.obscov.data_scle, ...
                      'twsc', ...
                      'evap', ...
                      settings.id_var, ...
                      settings.region_ids, ...
...
elseif strcmp(settings.obscov.errs_DM.method, 'data')
    % Load an ancillary time-series for deriving the percentage errors
    DM_in = prep_dta(settings.obscov.errs_DM.data, ...
                    [], ...
...
if ~isempty(settings.obs.p_alt)
    if isfield(settings.obscov, 'p_alt_errs')
        if strcmp(settings.obscov.p_alt_errs.method, 'data')
            P_in = prep_dta(settings.obscov.p_alt_errs.data, ...
                    [], ...
...
if ~isempty(settings.obs.e_alt)
    if isfield(settings.obscov, 'e_alt_errs')
        if strcmp(settings.obscov.e_alt_errs.method, 'data')
            E_in = prep_dta(settings.obscov.e_alt_errs.data, ...
                    [], ...
...
if ~isempty(settings.obs.r_alt)
    if isfield(settings.obscov, 'r_alt_errs')
        if strcmp(settings.obscov.r_alt_errs.method, 'data')
            R_in = prep_dta(settings.obscov.r_alt_errs.data, ...
                    [], ...
...
if ~isempty(settings.obs.dm_alt)
    if isfield(settings.obscov, 'dm_alt_errs')
        if strcmp(settings.obscov.dm_alt_errs.method, 'data')
            DM_in = prep_dta(settings.obscov.dm_alt_errs.data, ...
                    [], ...
